...
public class JdbcGroupDaoTest {
    ...
    @Test
    void testCreateAndGetGroupByName() {
        Group group = new Group("Beverages", "Hot and cold drinks");
        dao.createGroup(group);

        Optional<Group> found = dao.getGroupByName("Beverages");
    ...
    void testUpdateGroup() {
        ...
        Optional<Group> updated = dao.getGroupByName("Dairy");
    ...
    void testDeleteGroup() {
        ...
        Optional<Group> deleted = dao.getGroupByName("Snacks");
